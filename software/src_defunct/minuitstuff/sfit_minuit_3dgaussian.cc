...
CCF2S_Minuit_3DGaussian::CCF2S_Minuit_3DGaussian(CSourceCalc *scset,C3DArray *cexpset,
  ...
  pars[0].Set("lambda",(sourcecalc->spars).getD("lambda",1),1.0,0,0);
  pars[1].Set("Rx",(sourcecalc->spars).getD("Rx",5),1.0,0.0,20.0);
  pars[2].Set("Ry",(sourcecalc->spars).getD("Ry",5),1.0,0.0,20.0);
  pars[3].Set("Rz",(sourcecalc->spars).getD("Rz",5),1.0,0.0,20.0);
  pars[4].Set("Xoff",(sourcecalc->spars).getD("Xoff",0),1.0,0,0);

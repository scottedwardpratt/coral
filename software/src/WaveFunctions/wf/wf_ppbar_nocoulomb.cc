...
void CWaveFunction_ppbar_nocoulomb::GetBessel(complex<double> x,int iq,vector<complex<double>> &jl,vector<complex<double>> &jlprime){
	int ll;
...
void CWaveFunction_ppbar_nocoulomb::GetHankel(double x,int iq,vector<complex<double>> &hl,vector<complex<double>> &hlprime){
	double j,y,j1,y1;
	int ll;

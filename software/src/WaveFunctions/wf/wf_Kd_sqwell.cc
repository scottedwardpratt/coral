...
CWaveFunction_Kd_sqwell::CWaveFunction_Kd_sqwell(string parsfilename) : CWaveFunction(){
  ParsInit(parsfilename);

  m1=2.0*MPROTON-2.224; 
  m2=MKAON; 
  IDENTICAL=0;
...
CWaveFunction_Kd_sqwell::~CWaveFunction_Kd_sqwell(){
  SquareWell_DeleteArrays();
}


double CWaveFunction_Kd_sqwell::CalcPsiSquared(int iq,double r,double ctheta){
